...
class AmazonECS
{
  ...
  protected $webserviceWsdl = 'http://ecs.amazonaws.com/AWSECommerceService/2009-10-01/US/AWSECommerceService.wsdl';
  /**
   * The SOAP Endpoint
   *
   * @var string
  ...
  public function __construct($accessKey, $secretKey, $country, $associateTag)
  {
    ...
    $this->requestConfig['MerchantId']    = 'A2GJ4O7441GG83';
  ...
  public function merchant($mid = null)
  {
    if (null === $mid)
    {
    ...
    $this->requestConfig['MerchantId'] = $mid;
